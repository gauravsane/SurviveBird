...
new_icon = pygame.image.load('D:/Python/Survive_bird-main/Survive_bird-main/bird1.png')
...
#load images
bg_img = pygame.image.load('D:/Python/Survive_bird-main/Survive_bird-main/bg1.png')
ground_img = pygame.image.load('D:/Python/Survive_bird-main/Survive_bird-main/ground2.png')
button_img = pygame.image.load('D:/Python/Survive_bird-main/Survive_bird-main/restartBtn.png')
...
class Bird(pygame.sprite.Sprite):      #pygame sprite class we used
    def __init__(self, x, y):
        ...
        for num in range(1,3):
            img = pygame.image.load(f'D:/Python/Survive_bird-main/Survive_bird-main/bird{num}.png')
    ...
    def update(self):
        ...
        if game_over == False:
            ...
            if pygame.mouse.get_pressed()[0] == 1 and self.clicked == False:
                self.clicked = True
                path = 'D:/Python/Survive_bird-main/Survive_bird-main/wingsSound.mp3'
...
class Pipe(pygame.sprite.Sprite):
    def __init__(self, x, y, position):
        ...
        self.image = pygame.image.load('D:/Python/Survive_bird-main/Survive_bird-main/pipe2.png')
...
while run:
    ...
    if pygame.sprite.groupcollide(bird_group, pipe_group, False, False) or flappy.rect.top < 0:
        game_over = True
        sound = 'D:/Python/Survive_bird-main/Survive_bird-main/die.mp3'
